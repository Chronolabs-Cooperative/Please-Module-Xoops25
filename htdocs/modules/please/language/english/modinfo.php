...
define('_MI_PLEASE_ADMINMENU_MAILBOXES', 'Source Inboxes');
...
define('_MI_PLEASE_DEFAULT_REPLYTO','Default Tickets Reply To');
define('_MI_PLEASE_DEFAULT_REPLYTO_DESC','This is the default email address replies are written from!');
define('_MI_PLEASE_ATTACHMENT_STORAGE','File attachments are stored where by default');
define('_MI_PLEASE_ATTACHMENT_STORAGE_DESC','This is the path the file attachments are stored on from emails');
define('_MI_PLEASE_IMAGE_STORAGE','Images in emails are stored when retreived by default');
define('_MI_PLEASE_IMAGE_STORAGE_DESC','This is the pathe mail images are stored!');
