...
class pleaseDepartments extends pleaseXoopsObject
{
    ...
    {   	
        ...
        function getAdminListFormItems()
        {
        	...
        	$ret['actions'] = "<a href='" . XOOPS_URL . "/modules/$dirname/admin/edit-departments.php?id=" . $this->getMD5('id') . "' target='_blank'><img src='" . $pathIcon16 . "/edit.png' alt='" . sprintf(_AM_PLEASE_ADMIN_DEPARTMENTS_EDIT, $this->getVar('name')) . "' title='" . sprintf(_AM_PLEASE_ADMIN_DEPARTMENTS_EDIT, $this->getVar('name')) . "'/></a>&nbsp;";
        	return $ret;
        }
...
class pleaseDepartmentsHandler extends pleaseXoopsObjectHandler
{
    ...
    function getAddFormAdmin()
    {
    	...
    	$elements['mantis'] = new PleaseFormSelectEnumerator(_AM_PLEASE_ADDFORM_DEPARTMENT_MANTIS_TITLE, 'mantis', basename(__FILE__), 'mantis', 'no');
    	...
    	$elements['manager-name'] = new XoopsFormText(_AM_PLEASE_ADDFORM_DEPARTMENT_MANAGERNAME_TITLE, 'manager-name', 28, 128, '');
    	$elements['manager-name']->setDescription(_AM_PLEASE_ADDFORM_DEPARTMENT_MANAGERNAME_DESC);
    	$elements['manager-email'] = new XoopsFormText(_AM_PLEASE_ADDFORM_DEPARTMENT_MANAGEREMAIL_TITLE, 'manager-email', 28, 128, '');
