 ...
 */
class pleaseMailboxs extends pleaseXoopsObject
{
    ...
    {   	
        ...
        self::initVar('reply', XOBJ_DTYPE_TXTBOX, $pleaseConfigsList['default-reply'], false, 300);
        ...
        self::initVar('wammy-uri', XOBJ_DTYPE_TXTBOX, $pleaseConfigsList['default-wammy'], false, 300);
        ...
        self::initVar('waiting', XOBJ_DTYPE_INT, $pleaseConfigsList['default-waiting'], false);
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class pleaseMailboxsHandler extends pleaseXoopsObjectHandler
{
